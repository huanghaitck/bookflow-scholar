/* eslint-disable */
/**
 * Generated from BACKEND_CONTRACT_BUNDLE 1.2.0-r1.
...
export const BACKEND_CONTRACT_VERSION = "1.2.0" as const;
export const BACKEND_BUNDLE_REVISION = "1.2.0-r1" as const;
export const COMMAND_SCHEMA_VERSION = "1.2" as const;
export const SNAPSHOT_SCHEMA_VERSION = "bookflow-snapshot-v1.2" as const;
export const EVENT_SCHEMA_VERSION = "bookflow-event-v1.2" as const;
export const ERROR_SCHEMA_VERSION = "bookflow-error-v1.2" as const;
export const CAPABILITIES_SCHEMA_VERSION = "bookflow-capabilities-v1.2" as const;
...
export interface BackendCapabilities {
  ...
  supportsWebAssist: boolean;
  supportsGlossaryReviewExport: boolean;
  supportsGlossaryReviewImport: boolean;
  supportsDifficultPageExport: boolean;
  supportsDifficultPageImport: boolean;
  supportsWebAssistDiffPreview: boolean;
  supportsIncrementalRebuild: boolean;
  supportsWebAssistUndo: boolean;
  supportsProviderConnectionTest: boolean;
  supportsProviderConfigurationEdit: boolean;
  [futureField: string]: unknown;
}
...
export interface BackendSnapshot {
  ...
  web_assist_packages: unknown[];
  web_assist_history: unknown[];
...
export type WebAssistPackageType = "glossary_review" | "difficult_pages";

export interface WebAssistPackage extends JsonObject {
  package_id: string;
  package_type: WebAssistPackageType;
  project_id: string;
  source_document_id: string;
  source_hash: string;
  status: "exported" | "validated" | "conflicted" | "applied" | "undone" | "discarded";
  item_count: number;
  export_path: string;
  created_at: string;
  updated_at: string;
